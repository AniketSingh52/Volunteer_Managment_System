    ...
    <header class="bg-white shadow-sm">
        <nav class="container mx-auto py-4 px-10">
            <div class="flex justify-between items-center">
                ...
                <div class="hidden md:flex space-x-2">
                    ...
                    <a href="sign_up.php" class="px-4 py-2 bg-primary text-white font-bold rounded-lg hover:bg-primary-dark transition duration-300">Sign up</a>
                </div>
        ...
        <div id="mobile-menu" class="md:hidden hidden bg-white px-4 pt-2 pb-4 shadow-sm">
            ...
            <div class="mt-4 space-y-2">
                ...
                <a href="sign_up.php" class="block w-full px-4 py-2 text-center bg-primary text-white rounded hover:bg-primary-dark transition duration-300">Sign up</a>
            </div>
        </div>
    </header>
                    ...
                    <div class="flex flex-col md:flex-row items-center justify-between">
                        ...
                        <div class="w-full md:w-1/2 mb-12 md:mb-0">
                            ...
                            <div class="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                                <a href="#" class="bg-white text-blue-900 font-semibold px-8 py-3 rounded-full hover:bg-indigo-600 hover:text-white transition duration-300 text-center">Get Started</a>
