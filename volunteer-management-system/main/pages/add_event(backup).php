            ...
            <div class="max-w-7xl mx-auto px-4 py-3">
                ...
                <div class="mx-auto w-full px-12 py-6 rounded-lg bg-white">
                    ...
                    <form id="yourFormID" method="POST" enctype="multipart/form-data" action="add_event.php">
                        ...
                        <!--Causes-->
                        <div class="mb-5">
                            <label for="causes" class="mb-3 block text-base font-medium text-[#07074D]">Cause of the event: <span class="font-semibold text-gray-600 text-sm ml-1">(Tag)</span></label>
                            ...
                            <select required name="cause[]" multiple
                                ...
                                id="cause" class=" w-full  rounded-md border border-[#e0e0e0] bg-white py-6 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md">
                                <?php
                        ...
                        <!--Skill-->
                        <div class="mb-5">
                            <label for="skill" class="mb-3 block text-base font-medium text-[#07074D]">Skills Required: <span class="font-semibold text-gray-600 text-sm ml-1">(At least One)</span></label>
                            <!-- <input name="skill" id="name" type="text" class="bg-gray-100 w-full text-gray-800 text-sm px-4 py-3.5 rounded-md focus:bg-white outline-blue-500 transition-all" placeholder="Enter name" /> -->
                            <select required name="skill[]" multiple
                                multiselect-search="true"
                                multiselect-select-all="true"
                                multiselect-max-items="5"
                                multiselect-hide-x="false"
