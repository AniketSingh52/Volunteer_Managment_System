...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    $sql = "SELECT * FROM `pictures` p JOIN `user` u ON p.user_id = u.user_id
            WHERE picture_id = ?";
                ...
                <div class="mx-auto max-w-7xl px-6 pt-2 pb-6 sm:pb-10 lg:flex lg:px-8 ">
                    <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl lg:flex-shrink-0 lg:pt-8">
                        ...
                        <p class="mt-6 text-lg leading-8 text-gray-600">
                            Show Case Your Memories To Motivate the community so as to make a difference together.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <form id="yourFormID" method="POST" enctype="multipart/form-data" class="space-y-12">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm p-8 space-y-6">
                        <div class="border-b border-gray-200 pb-6">
                            <h2 class="text-2xl font-bold text-gray-900">Choose Image</h2>
                            <p class="mt-1 text-sm text-gray-500">The image you want to share with the community.</p>
                        </div>
                        ...
                        <div class="flex justify-center">
                            <div class="relative group">
                                ...
                                <div class="h-[400px] w-[600px] bg-gray-100 border-2 border-dashed border-gray-300 rounded-2xl overflow-hidden group-hover:border-indigo-500 transition-colors duration-300">
                                    <img id="preview-image" src="<?= $picture_url ?>" class="profile-image w-full h-full object-cover">
                                    <div class="flex flex-col items-center justify-center h-full" id="upload-prompt">
                                        ...
                                        <div class="flex text-sm text-gray-600 mt-4">
                                            <label for="volunteer-profile-photo" class="relative cursor-pointer rounded-md font-medium text-indigo-600 hover:text-indigo-500">
                                                ...
                                                <input type="hidden" name="post_poster" value="<?= $picture_url_old ?>" />
                                            </label>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm p-8 space-y-8">
                        <div class="border-b border-gray-200 pb-6">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Details about your Post.</p>
                        </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm p-8 space-y-8">
                        <div class="border-b border-gray-200 pb-6">
                            <h2 class="text-2xl font-bold text-gray-900">Caption</h2>
                            <p class="mt-1 text-sm text-gray-500">Provide a short description about your post.</p>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                class="block w-full rounded-lg border-gray-300 py-3 px-4 text-gray-900 focus:ring-2 focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm"><?= $caption ?></textarea>
                        </div>
                    </div>
        ...
        $(document).ready(function() {
            ...
            $("#yourFormID").submit(function(e) {
                ...
                if (poster_change) {
                    ...
                    //   Send AJAX request
                    $.ajax({
                        url: "Backend/edit_post.php", // Update with your correct path to dl.php
                        type: "POST",
                        data: formData,
                        cache: false,
