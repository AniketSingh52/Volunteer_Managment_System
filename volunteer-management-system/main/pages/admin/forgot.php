...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (mysqli_num_rows($result) > 0) {
    ...
    try {
      ...
      $mail->Username   = 'aniketsingh42242@gmail.com';                     //SMTP username
      $mail->Password   = 'gborobdfmhbohmqd';                               //SMTP password
      $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
      $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`
      $mail->SMTPDebug = 0; // Ensure this is set to 0
      //Recipients
      $mail->setFrom('aniketsingh42242@gmail.com', 'AniketSingh');
  ...
  <div class="max-w-md mx-auto">
    ...
    <form id="loginForm" class="bg-white rounded-xl shadow-lg p-8 space-y-3" method="POST" action="forgot.php">
      ...
      <div class="text-center text-sm">
        ...
        <a href="login_in2.php" class="text-purple-600 hover:text-purple-500 font-medium ml-1">Sign-In</a>
      </div>
    </form>
