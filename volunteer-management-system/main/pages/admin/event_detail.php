                            ...
                            <div class="bg-white rounded-2xl shadow-lg p-8 ">
                                ...
                                <div class="space-y-8 max-h-96 overflow-y-scroll overflow-x-hidden">
                                    ...
                                    <?php foreach ($notices as $notice) :
                                        ...
                                        $profile =  $notice['profile_picture'];
                        ...
                        <div class="bg-white rounded-2xl shadow-lg p-8 ">
                            ...
                            <div class="space-y-8 review_list">
                                <?php foreach ($reviews as $review) :
                                    ...
                                    $profile =  $review['profile_picture'];
                            ...
                            <div class="flex flex-col space-y-4">
                                ...
                                <?php
                                  ...
                                  if ($flag2) {
                                    ...
                                    echo '
                                    <a href="https://mail.google.com/mail/?view=cm&fs=1&to=' . $user_email . '&su=Inquiry about the Event&body=Hello, I am the admin of this platform and would like to ask a feek things."
                                    target="_blank"
